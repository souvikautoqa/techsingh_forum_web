                    ...
                    <div class="col-md-6 col-lg-6 col-xxl-6">
                        <div class="card" data-aos="fade-up" data-aos-easing="linear">
                            <div class="card-body p-4 p-xl-5">
								...
								<form method="POST" action="<?= base_url() ?>reset-password/post/<?= $token ?>">
								
									<div class="pb-3">
										<label class="form-label rd-input-label focus not-empty" for="password">New Password</label> 
										<input type="password" id="password" name="password" class="form-control" required>
									</div>

									<div class="pb-3">
										<label class="form-label rd-input-label focus not-empty" for="confirm_password">Confirm Password</label> 
										<input type="password" id="confirm_password" name="confirm_password" class="form-control" required>
									</div>

									<div class="pb-3">
										<button type="submit" id="submit-btn" class="w-100 btn btn-mint">Submit</button>
									</div>
								</form>
