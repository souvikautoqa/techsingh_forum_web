                                                ...
                                                <div class="qa-holder">
                                                    ...
                                                    <div class="qa-content mb-">
                                                        <div class="post-heading d-flex justify-content-between">
                                                            <h1>
                                                                <a href="<?= base_url() . 'pending-approval/' . $post['url_slug'] ?>">
                                                                    <?= $post['title'] ?>
                                                                </a>
                                                            </h1>
                                                            <?php 
                                                            ...
                                                            ?>
                                                                <a href="<?=base_url()?>moderator/edit/post/<?= $post['url_slug'] ?>">
                                                                    <span class="qa-text">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap mb-">
                                                            <span class="qa-category">
                                                                <a href="<?= base_url() . $post['category_slug'] ?>">
                                                                    <?= $post['category_name'] ?>
                                                                </a>
                                                            </span>
                                                            <span class="qa-text">
                                                                <i class="bi bi-clock-history"></i> <?= time_elapsed_string($post['created_at']) ?>
                                                            </span>
                                                        </div>
                                                    </div>
